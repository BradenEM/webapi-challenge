## Deployed at https://web-api-sprint.herokuapp.com
...
Two parts of express that I learned about are res.status(xxx) and req.body. I also learned that Express is middleware and can also be used to break the application into routers.
...
A resource is any object that can be reached and manipulated using HTTP Methods.

- [x] What can the API return to help clients know if a request was successful?

It can return a status which could you give you some clue of what you just did with the request or the error in why it didn't work. You can also return custom messages back to the client with more information.

- [x] How can we partition our application into sub-applications?

Break it up using routers.
